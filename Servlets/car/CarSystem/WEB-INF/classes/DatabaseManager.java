...
public static int GetVehicle(String company, String model, String color, String register, String price, boolean ac, boolean cng, boolean powerWindow, int transmission, String city, int carType)throws  Exception{
String query="SELECT  * from user u, vehicle v  where u.user_id = v.user_id And company LIKE '"%+ company+%"'  And model LIKE  '%'"+ model +%"'  And color LIKE '"%+color+%"' And register LIKE '"%+register+%"' And ac LIKE '"%+ac+%"' And cng Like '"%+cng+%"' And power_window Like '"%+powerWindow+%"' And transmission Like '"%+transmission+%"' And City Like '"%+city+ %"' And car_type Like '"%+carType+%"' And price like "%+price+%"  ;  
...
//String query="SELECT  * from user u, vehicle v  where u.user_id = v.user_id And company LIKE '"%+ company+%"'  And model LIKE  '%'"+ model+%"'  And color LIKE '"%+color+%"' And register LIKE '"%r+egister+%"' And ac LIKE '"%+ac+%"' And cng Like '"%+cng+%"' And power_window Like '"%+power_window+%"' And transmission Like "%+transmission+%" And City Like '"+city+'";  
