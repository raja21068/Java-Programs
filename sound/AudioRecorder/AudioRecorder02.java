...
public class AudioRecorder02 extends JFrame{
  ...
  final JButton captureBtn = new JButton("Capture",new ImageIcon("record.png"));
  final JButton stopBtn = new JButton("Stop",new ImageIcon("stop.png"));
  final JButton playBtn = new JButton("Play",new ImageIcon("play.png"));
  final JButton saveBtn=new JButton("Save",new ImageIcon("save.png"));
