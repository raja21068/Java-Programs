...
public class ZipClass {
   ...
   private static void folderHelper(String src ,ZipOutputStream zipOut , String path)throws Exception{
   ...
   private static void fileHelper(String src,ZipOutputStream zipOut , String path)throws Exception{
