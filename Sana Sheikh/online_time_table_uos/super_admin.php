    ...
    <body class=" ">
                ...
                <div class="span10 offset1">
                    ...
                    <div class="tabbable custom-tabs tabs-animated  flat flat-all hide-label-980 shadow track-url auto-scroll">
                        <ul class="nav nav-tabs">
                            <li class="active"><a onclick="setDepartments(this)" href="#teacher" data-toggle="tab" class="active "><i class="icon-th-large"></i>&nbsp;<span>Departments</span></a></li>
                            <li><a href="#" onclick="setUsers(this)" data-toggle="tab"><i class="icon-user"></i>&nbsp;<span>Users</span></a></li>
                        </ul>
        ...
        <script type="text/javascript">
                                ...
                                function setUsers(element) {
                                    ...
                                    $(element).find('i').remove();
                                    $(element).prepend("<img id='#ico' src='ajax-process-small.gif'>");
                                    $.post("user_tab.php", {}, function(response) {
                                        setTimeout("finishAjax('tab-content', '" + escape(response) + "')", 400);
                                        $(element).find('img').remove();
                                        $(element).prepend(i);
                                    });
