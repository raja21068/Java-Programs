...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class=" ">
        <script type="text/javascript">
            ...
            setTeacher(document.getElementById('a_teacher'));
            function setTeacher(element) {
                var i = $(element).find('i');
                $(element).find('i').remove();
                $(element).prepend("<img id='#ico' src='ajax-process-small.gif'>");
        ...
        <div class="container" style="width: 1000px; margin-left: 10px;">



            <div class="row-fluid" id="demo-1">
                <div class="span10 offset1">
                    <h4><?php echo ''.$_COOKIE['deptName'];?></h4>
                    <div class="tabbable custom-tabs tabs-animated  flat flat-all hide-label-980 shadow track-url auto-scroll">
                        <ul class="nav nav-tabs">
                            <li class="active"><a id="a_teacher" onclick="setTeacher(this);" href="#teacher" data-toggle="tab" class="active "><i class="icon-user"></i>&nbsp;<span>Teacher</span></a></li>
                            <li><a href="#" onclick="setPrograms(this)" data-toggle="tab"><i class="icon-th-large"></i>&nbsp;<span>Programs</span></a></li>
                            <li><a href="#" onclick="setPart(this)" data-toggle="tab"><i class="icon-th-list"></i>&nbsp;<span>Part</span></a></li>
                            <li><a href="#" onclick="setCourse(this)" data-toggle="tab"><i class="icon-th"></i>&nbsp;<span>Courses</span></a></li>
                            <li><a href="#" onclick="setTimes(this)" data-toggle="tab"><i class="icon-time"></i>&nbsp;<span>Times</span></a></li>
                            <li><a href="#" onclick="setRooms(this)" data-toggle="tab"><i class="icon-qrcode"></i>&nbsp;<span>Rooms</span></a></li>
                            <li><a href="#" onclick="setTimetable(this)" data-toggle="tab"><i class="icon-time"></i>&nbsp;<span>Time Table</span></a></li>
                        </ul>
