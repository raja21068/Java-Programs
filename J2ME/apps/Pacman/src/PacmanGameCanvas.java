...
public class PacmanGameCanvas extends GameCanvas implements Runnable{
	...
	public PacmanGameCanvas()throws Exception{
		...
		//bars.addElement(new Rectangle(60,80,10,35));										 // left vertical bar	
		//bars.addElement(new Rectangle(170,80,10,35));										 // right vertical bar
		
		
		//bars.addElement(new Rectangle(60,120,30,10));										 // left horizontal bar	
		//bars.addElement(new Rectangle(150,120,30,10));   	 								 // right horizontal bar
