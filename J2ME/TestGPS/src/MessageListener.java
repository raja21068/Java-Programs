...
/**
 * Implements this interface to be informed when a NMEA message is received by the API.
...
public interface MessageListener {
    ...
    /**
     * Called when a NMEA message is received by the API.
     * @param NMEAMessage The message received.
     */
