...
{
	//private static //logger //logger = //logger.get//logger(Sms.class);
	...
	public static void main(String[] args){
		...
		params.setPortName("COM16"); // default COM1
		...
		try{
			...
			System.out.println();
			*/		
			sms.openConnection("COM16");
			sms.SendMessage("+923332756355", "+923330005150", "Testing Network connection");
			...
			//System.out.println(sms.getSmsMemory());
