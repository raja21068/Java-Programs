...
public class Krizalid implements KeyListener {
	JFrame win=new JFrame();	
	static int i=20,j=5;
	static JLabel stand=new JLabel(new ImageIcon("standkrizalid.gif"));
	JLabel pic2=new JLabel(new ImageIcon("levelnew.jpg"));
	JLabel run2=new JLabel(new ImageIcon("runkrizalid1.gif"));
	JLabel standback=new JLabel(new ImageIcon("standbackkrizalid.gif"));
	JLabel back=new JLabel(new ImageIcon("runbackkrizalid.gif"));
	...
	JLabel fire=new JLabel(new ImageIcon("krizalidfire.gif"));
	JLabel backfire=new JLabel(new ImageIcon("fireback.gif"));
