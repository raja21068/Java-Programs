...
//        String defaultVideoFormatString = "size=176x144, encoding=rgb, maxdatalength=76032";
  ...
  public String getProcessAcknowledge(){
      return result;
  }
  
  public String startTransmission(String result , String ipAdd , int port){
  	
	result = createTransmitter(ipAdd, port);
	if (result != null) {
	    processor.close();
	    processor = null;
	    return result;
...
//	setJPEGQuality(processor, 0.5f);
    ...
    private String createTransmitter(String ipAddress , int port) {
    try {
  ...
  return null;
    ...
    public void setControlEvent(Processor p){
