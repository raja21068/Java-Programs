 ...
 */
    ...
    class cityPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('cityssearch', $this->dataset,
                array('city_id', 'city_from', 'city_to', 'remarks'),
                array($this->RenderText('City Id'), $this->RenderText('City From'), $this->RenderText('City To'), $this->RenderText('Remarks')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('cityasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('city_id', $this->RenderText('City Id')));
        ...
        {
            //
            // View column for city_id field
            //
            $column = new TextViewColumn('city_id', 'City Id', $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'city_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'cityGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new cityPage("city.php", "city", GetCurrentUserGrantForDataSource("city"), 'UTF-8');
        $Page->SetShortCaption('City');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('City');
