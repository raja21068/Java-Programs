...
public class Client extends javax.swing.JFrame implements KeyListener {
	...
	void initComponents()throws Exception{
		...
		transfer.addActionListener(new java.awt.event.ActionListener(){
			public void actionPerformed(ActionEvent e){
				try{
				socket = new java.net.Socket(ipTxt.getText(),9000);
        ...
        public void sendFolder(java.io.File f)throws Exception{
        ...
        public void sendFile(java.io.File f)throws Exception{
            ...
            new TransferThread(f ,fileSize ,packetSize, totalPacket, socket , inFile,progressBar, transPackLbl).send();
        }
