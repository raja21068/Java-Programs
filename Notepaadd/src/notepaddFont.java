...
class notepaddFont extends JDialog implements ListSelectionListener,ActionListener {
	...
	void fontstyle(){
		...
		vst.addElement("Bold");
		vst.addElement("Italic");
		vst.addElement("Italic Bold");
		l2.setListData(vst);
	}
	...
	public void valueChanged(ListSelectionEvent arg0) {
		...
		if(s2.equals("Italic")){ s2="2"; }
		if(s2.equals("Italic Bold")){s2="3";}
		...
		fonttf.setFont(new Font(s1,s4,s5));
		String s="AaBbYyZz";
		fonttf.setText(s);
		}
	@Override
	public void actionPerformed(ActionEvent e) {
		...
		if(ob==fontok){ note.txt.setFont(new Font(s1,s4,s5)); dispose(); }
