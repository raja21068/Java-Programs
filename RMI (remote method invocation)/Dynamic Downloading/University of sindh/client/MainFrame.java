...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() throws Exception{
        initComponents();
	DatabaseManagerInterface ob  = (DatabaseManagerInterface)Naming.lookup("rmi://localhost:1099/Service");
        setVisible(true);
	
        facultyFrame = new FacultyFrame(this, ob); 
        department = new DepartmentFrame(this, ob);
        programFrame = new ProgramFrame(this, ob);
        batchFrame = new BatchFrame(this, ob);
        studentFrame = new StudentFrame(this, ob);
    ...
    public FacultyFrame facultyFrame;
    public DepartmentFrame department;
    public ProgramFrame programFrame;
    public BatchFrame batchFrame;
    public StudentFrame studentFrame;
}
