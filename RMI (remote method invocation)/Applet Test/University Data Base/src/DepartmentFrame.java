 ...
 * @author Jay Kumar
 */
public class DepartmentFrame extends Applet {
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt)throws Exception {//GEN-FIRST:event_addBtnActionPerformed
        ...
        if(check){
            javax.swing.JOptionPane.showMessageDialog(null,"This department is already in record....");
        }
        else{
            DatabaseManager.addDepartment(depBean);
            javax.swing.JOptionPane.showMessageDialog(null,"The department "+depBean+" has added to record....");
    ...
    private void DelBtnActionPerformed(java.awt.event.ActionEvent evt)throws Exception {
         if(this.departmentList.isSelectionEmpty()){
            JOptionPane.showMessageDialog(null, "No department is selected from list...");
            return;
        }
