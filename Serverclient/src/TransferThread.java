...
class TransferThread extends Thread{
	...
	TransferThread(java.io.File file,int fileSize , int packSize , int totalPack ,java.net.Socket socket,java.io.DataInputStream inFile , javax.swing.JProgressBar bar){
		f = file;
