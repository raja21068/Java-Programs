...
public class MainFrame extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(passwordTextFieldBG, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
                                    .addComponent(urlTextFieldBG)
                                    .addComponent(usernameTextFieldBG, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(urlTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 156, Short.MAX_VALUE)
    ...
    private void generateDbmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateDbmButtonActionPerformed
        new Thread(){
            ...
            public void run() {
                ...
                try{
                    if(javaRadioButton.isSelected()){
                        JavaMethodGenerator.generateDBM(des.getAbsolutePath(), dbPath, statusLabel);
                    }else if(vbRadioButton.isSelected()){
                        VisualBasicMethodGenerator.generateDBM(des.getAbsolutePath(), dbPath,statusLabel);
                    }else if(csRadioButton.isSelected()){
                        CSharpMthodGenerator.generateDBM(des.getAbsolutePath(), dbPath, statusLabel);
                    } 
    ...
    private void dbTypeComboBoxBGItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_dbTypeComboBoxBGItemStateChanged
        ...
        if(str.equals(".mdb")){
            ...
            urlTextFieldBG.setText("jdbc:mysql://localhost:3306/db");
            usernameTextFieldBG.setText("root");
            passwordTextFieldBG.setText("");
               ...
               String dbtype = (String)dbTypeComboBoxBG.getSelectedItem();
                ...
                try{
                    if(queryRadioButton.isSelected()){
                        QueriesGenerator.generateDBM(des.getAbsolutePath(), dbPath,statusLabel);
