...
//        this.list.setListData(new Object[]{});
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        stBean.setBatchId(bat.getBatchId());
        stBean.setStudentName(this.stdNameTxt.getText());
        stBean.setFatherName(this.fNameTxt.getText());
        stBean.setSurname(this.surnameTxt.getText());
        stBean.setRollNo(this.rollNoTxt.getText());
        stBean.setCNIC(this.cnicText.getText());
        stBean.setCellNo(this.cellNoTextField.getText());
        stBean.setGroup(TypeEncoder.encode(groupComboBox.getSelectedItem().toString()));
         
        stBean.setShift(TypeEncoder.encode(shiftComboBox.getSelectedItem().toString()));
        stBean.setAddress(this.addressText.getText());
        stBean.setRemarks(this.remarksTextArea.getText());
       try{
...
//            Logger.getLogger(BatchFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void batchComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_batchComboBoxItemStateChanged
        ...
        try{
            ...
            java.util.Vector v = DatabaseManager.getAllStudents(batBean.getBatchId());
            if(v==null)list.setListData(v);               
            else list.setListData(v);
        }catch(Exception ex){ex.printStackTrace();}
//        clear();
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        stBean.setCellNo(this.cellNoTextField.getText());
        stBean.setGroup(TypeEncoder.encode(groupComboBox.getSelectedItem().toString()));
        stBean.setShift(TypeEncoder.encode(this.shiftComboBox.getSelectedItem().toString()));
        stBean.setAddress(this.addressText.getText());
        stBean.setRemarks(this.remarksTextArea.getText());
        try{
    ...
    private void listValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listValueChanged
        ...
        this.fNameTxt .setText(stBean.getFatherName());
