...
public class SaleBookFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(240, 0, 140, 30);
        ...
        quantityLabel.setBounds(30, 280, 100, 30);
        ...
        quantityTextField.setBounds(130, 280, 120, 30);

        jLabel10.setText("press enter");
        getContentPane().add(jLabel10);
        jLabel10.setBounds(260, 290, 90, 14);
        ...
        jScrollPane1.setBounds(30, 320, 610, 190);
        ...
        clearButton.setBounds(350, 520, 100, 30);
        ...
        billDateLabel.setBounds(480, 280, 150, 30);
        ...
        paidAmountTextField.setBounds(530, 550, 110, 20);
        ...
        paidAmountLabel.setBounds(440, 550, 90, 20);
        ...
        printButton.setBounds(280, 600, 100, 41);
        ...
        jScrollPane2.setBounds(80, 560, 160, 60);
        ...
        updateBillButton.setBounds(210, 520, 120, 30);

        accountTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sale", "Expanse" }));
        ...
        accountTypeComboBox.setBounds(510, 10, 100, 30);

        accountTypeLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        accountTypeLabel2.setText("<html>ACCOUNT<center>TYPE</center><html>");
        getContentPane().add(accountTypeLabel2);
        accountTypeLabel2.setBounds(450, 20, 60, 30);
    ...
    private void quantityTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_quantityTextFieldActionPerformed
        ...
        if(quantity > bean.getQuantity()){
                JOptionPane.showMessageDialog(this, "product out of stock.../n you have not enough products");
                quantityTextField.setText(""+0);
                return;
            }
            this.addRowInTable(bean,quantity, bean.getRate());
    ...
    private void billNoTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_billNoTextFieldActionPerformed
        ...
        try{
            List list = DatabaseManager.getData(SalePurchase.class.getName(), "SALE_PURCHASE_ID="+billNo+" AND TYPE="+Constant.SALE, " DAY_ID DESC");
        ...
        for(int i=0;i<billInfoList.size();i++){
            ...
            try{
                if(row<0){
                    ...
                    DatabaseManager.updateData(p);
                    //DataManager.updateSaleProduct(oldInfo.productId, (oldInfo.quantity-quantity));
                }
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        try {
            Object ob = dateComboBox.getSelectedItem();
            String date = "";
            if(ob !=null) date=ob.toString();
            if(!billDateLabel.getText().trim().isEmpty()){
                date = billDateLabel.getText();
            }
            new PrintBill(accountsList.getSelectedValue().toString(), billNoTextField.getText(),date, Double.parseDouble(paidAmountTextField.getText().trim()), Double.parseDouble(totalAmountTextField.getText().trim()),tableModel).doPrint();
        } catch (Exception ex) {
            Logger.getLogger(SaleBookFrame.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, ex);
        }
    ...
    private void refreshAccountsList(){
        List list = DatabaseManager.getData(Account.class.getName(), "ACCOUNT_TYPE="+constant.Constant.SALE, "ACCOUNT_NAME ASC");
        accountsList.setListData(list.toArray());
    }
//    private void refreshProductsList(){
//        List list = DatabaseManager.getData(Product.class.getName(), "PRODUCT_NAME ASC");
//        productList.setListData(list.toArray());
//    }
   ...
   private void setMaxBillId(){
    ...
    private void generateBill(){
        ...
        try {
            ...
            bean.SalePurchase sale = new bean.SalePurchase(daybean, accountbean,  totalAmount, Constant.SALE, remarksTextArea.getText().trim().toUpperCase(),paidAmount);
            ...
            for(int i=0; i<tableRow;i++){
                ...
                Transaction tr = new Transaction(daybean, accountbean, productBean, sale, quantity, rate, Constant.SALE);;
                tr.setProductOriginalRate(productBean.getOriginalRate());
