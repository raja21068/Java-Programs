...
public class BatchFrame extends javax.swing.JFrame {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        Program pBean = (Program)progNameComboBox.getSelectedItem();
      
        try{
            DatabaseManager.addBatch(pBean.getProgID(), Integer.parseInt(this.batchYearTextField.getText()),TypeEncoder.encode(shiftComboBox.getSelectedItem().toString()), TypeEncoder.encode(groupComboBox.getSelectedItem().toString()), TypeEncoder.encode(sessionComboBox.getSelectedItem().toString()), this.remarkTxt.getText());
    ...
    private void facNameComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_facNameComboBoxItemStateChanged
        ...
        try{
            ArrayList list = DatabaseManager.getDepartment(facBean.getFactId());
            for(int i =0 ;i<list.size() ; i++){
                depNameComboBox.addItem(list.get(i));
            }
    ...
    private void progNameComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_progNameComboBoxItemStateChanged
        ...
        try {
            ...
            batchList.setListData(vec.toArray());
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void batchListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_batchListValueChanged
        ...
        Batch batBean = (Batch)batchList.getSelectedValue();
    ...
    private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
        ...
        Batch batBean = (Batch)batchList.getSelectedValue();
        try{
            DatabaseManager.deleteBatch(batBean.getBatchID());
        }catch(Exception ex){ex.printStackTrace();}
        progNameComboBoxItemStateChanged(null);
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        Program prog = (Program) progNameComboBox.getSelectedItem();
        Batch batBean = (Batch)batchList.getSelectedValue();
        
        try{
            DatabaseManager.updateBatch(prog.getProgID(),batBean.getBatchID(),Integer.parseInt(this.batchYearTextField.getText()),TypeEncoder.encode(shiftComboBox.getSelectedItem().toString()),TypeEncoder.encode(groupComboBox.getSelectedItem().toString()),TypeEncoder.encode(sessionComboBox.getSelectedItem().toString()),this.remarkTxt.getText());
        }catch(Exception ex){ex.printStackTrace();}
        progNameComboBoxItemStateChanged(null);
